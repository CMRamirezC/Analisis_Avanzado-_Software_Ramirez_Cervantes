...
1. Especifique el  **Objetivo general** del caso de estudio, recordándose que se debe indicar lo que se busca con el proyecto.
     ...
     * Ofrecer la mejor solución para que tomar cursos que influyen en el desempeño de una empresa, sea lo más sencillo y accesible posible para el usuario.

2. Especifique tres **objetivos específicos**, recordándose que deben ser medibles, cuantificables y logrables.

    * Optimizar el proceso de entrenamiento de personal, reduciendo el tiempo de dicho proceso.
    * Aumentar el porcentaje de personal que se certifica cada determinado tiempo. 
    * Reducir tiempos caídos por falta de entrenamiento / certificación de empleados.
...
!["Modelado de negocio"](../Archivos_Proyecto/Modelo%20de%20negocios.png)
...
:house: [Ir a mi repositorio](https://github.com/CMRamirezC/Analisis_Avanzado-_Software_Ramirez_Cervantes.git)